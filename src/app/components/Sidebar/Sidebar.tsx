export default function Sidebar() {
    return (
        ...
        <div className="cursor-pointer flex items-center rounded-tr-full rounded-br-full bg-[#FFBF00] space-x-2 pl-[2.12rem] py-3 pb-3">
           <p className="text-white text-lg capitalize">Cartão Atual</p>
        </div>
